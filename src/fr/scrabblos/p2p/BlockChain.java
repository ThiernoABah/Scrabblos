...
public class BlockChain {
	...
	public Condition auteurTour = lock.newCondition();
	public Condition politicienTour = lock.newCondition();
	
	public Condition vote = lock.newCondition();
